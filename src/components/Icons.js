...
export const CircularText = ({ className, text = "C++ Game Developer", ...rest }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="496"
        height="496"
    ...
    >
        <defs>
            <path
                id="circlePath"
                d="M248,248 m-150,0 a150,150 0 1,1 300,0 a150,150 0 1,1 -300,0"
            />
        </defs>
        <text fill="currentColor" fontSize="24" fontWeight="bold">
